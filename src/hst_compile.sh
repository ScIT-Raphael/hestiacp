...
# Prompt for Git branch to download and build from
...
GIT_REP='https://raw.githubusercontent.com/kristankenney/hestiacp/'$branch'/src/deb'
...
HESTIA='https://github.com/kristankenney/hestiacp/archive/'$branch'.zip'
...
apt-get -qq update
echo "Installing dependencies required for compilation..."
